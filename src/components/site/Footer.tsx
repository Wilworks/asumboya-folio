      ...
      <div className="container-x footer-grid">
        ...
        <div className="footer-col">
          ...
          <div className="socials">
            ...
            <a className="social-btn" href="https://linkedin.com/in/asumboya-wilfred-573321283" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            ...
            <a className="social-btn" href="https://github.com/Wilworks" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
